...
const init = () => {
  ...
  inputToDoContainer.prepend(inputToDo); // adds an inputToDo element to the beginning
  toDoList.append(inputToDo); // appends the inputToDo element to the toDoList
  toDoList.append(ulList); // appends a ulList element to the toDoList
  toDoList.append(clearAllBtn); // appends a clearAllBtn element to the toDoList
  ToDoListArray.print(ulList); // prints out ToDolistArray elements in ulList
};
